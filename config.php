...
session_name('TESTEST');

##  $WikiTitle is the name that appears in the browser's title bar.
$WikiTitle = 'JBW Lab WIKI v2.0';
...
$DefaultPasswords['admin'] = crypt('adminbitches');
...
$EnableUpload = 1;
$UploadPermAdd = 0;
$DefaultPasswords['upload'] = crypt('jbwlabn0t3b00k');
$UploadPrefixFmt = '/$Group/$Name';
$UploadBlacklist = array('.php', '.pl', '.cgi'); # disallow common script files
$UploadMaxSize = 2000000; #upload file size limit 2MB
$UploadExts['csv'] = array(
	'csv' => 'text/plain', # Comma separated value file
	'pdf' => 'application/pdf', # PDF document
	'png' => 'image/png', # portable network graphics
	'html' => 'text/html', #HTML!
	'tex' => 'pplication/x-tex' #LaTEX
	);
...
## indicate that to edit people must log in
$DefaultPasswords['edit'] = 'id:Danny';